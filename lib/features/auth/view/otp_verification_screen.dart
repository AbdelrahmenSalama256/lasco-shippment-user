        ...
        listener: (context, state) {
          if (state is OtpVerificationSuccess) {
            if (isResetPassword == true) {
              // Navigate to change password screen for reset flow
              Navigator.push(
                context,
                MaterialPageRoute(
          ...
          } else if (state is ResendOtpCodeSuccess) {
            showToast(
              context,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Directionality(
                    ...
                    child: Pinput(
                      length: 4,
                      enabled: state is OtpVerificationLoading ? false : true,
                      ...
                      onCompleted: (pin) {
                        if (isResetPassword == true) {
                          cubit.verifyForgotPasswordOtp(phoneNumber);
                        } else {
